          ...
          <nav class="navbar navbar-default" role="navigation">
            <div class="container-fluid">
                  ...
                  <ul class="nav navbar-nav">
                      ...
                      <li><a href="jobdashboard.jsp" target="_blank">DashBoard</a></li>
                  </li>
                 </ul>
...
<div class="container">
<form class="form-horizontal" role="form" method="post" action="seekupdate.jsp" enctype="multipart/form-data">
